...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 08, 2019 at 01:09 PM
...
CREATE TABLE IF NOT EXISTS `credit_transaction` (
  `CreditT_ID` int(11) NOT NULL AUTO_INCREMENT,
  `Customer_ID` varchar(255) NOT NULL,
  `Staff_ID` int(11) NOT NULL,
  `Action` varchar(255) NOT NULL,
  `Amount` varchar(255) NOT NULL,
  `Date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`CreditT_ID`)
) ENGINE=MyISAM AUTO_INCREMENT=90015 DEFAULT CHARSET=latin1;
...
('TP044765', 'CHEW II TUNG', 'e342ef77adc328d7e9654b2543fdac4e', 'student', 'male', '8029029019', '01832252351', 'zengkeat@gmail.com', 'my name is chew ii tung', '7628.57', 'cardi b.jpg'),
('TP044766', 'Giam Zeng Keat', 'e342ef77adc328d7e9654b2543fdac4e', 'Student', 'male', '980308146177', '018-3225235', 'zengkeat@gmail.com', 'UCDF1705ICT(SE)', '1000', 'jonny depp.jpg'),
('TP043234', 'Tan Hong Chin', '523cbae9edf8fea49fba3d45afd63abd', 'Student', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qwe', '0.00', 'default.jpg'),
('TP123534', 'Tan Hong Chin', 'c5af64ec2a73334c4404862af794e53d', 'Student', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '0.00', 'default.jpg'),
('TP044245', 'qwe', '523cbae9edf8fea49fba3d45afd63abd', 'Student', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '0.00', 'default.jpg'),
('TP044246', 'qwe', '523cbae9edf8fea49fba3d45afd63abd', 'Student', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '0.00', 'default.jpg'),
('TP044247', 'qwe', '523cbae9edf8fea49fba3d45afd63abd', 'Student', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '0.00', 'images/default.jpg'),
('TP123123', 'Tan Hong Chin', '523cbae9edf8fea49fba3d45afd63abd', 'Student', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '0.00', 'images/default.jpg'),
('TP518556', 'Tan Hong Chin', '62dd9c4c9bd5f9d61f98a7887925d39b', 'Student', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '0.00', 'images/default.jpg'),
('TP134677', 'Tan Hong Chin', '6ca6f406de99303108c32fcf4f2898f3', 'Student', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '0.00', 'default.jpg'),
('LC852147', 'Tan Hong Chin', '5b8498b215c3df098317fd952b624312', 'Lecturer', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '0.00', 'default.jpg'),
('ST456789', 'Tan Hong Chin', '7c8f9d71b410881488b7906542d06ea0', 'Staff', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '0.00', 'default.jpg'),
('LC044766', 'Tan Hong Chin', 'e5c704ad523265430e682be1f6c5724c', 'Lecturer', 'male', '123123123123', '01111982216', 'hongchin42@gmail.com', 'qweqwe', '10', 'jonny depp.jpg'),
('TP461543', 'wong', '680a254b6dc87cff9d5ab2ff40560151', 'Student', 'male', '324322234432', '3123131433', 'vfxv42@gmail.com', 'qwe', '0.00', 'default.jpg'),
('TP123125', 'wgtd', '4f326c40ccca6837663037342b8bc029', 'Student', '', '123123123123', '0111198221', 'sfsf2@gmail.com', 'qweqwe', '0.00', 'default.jpg'),
('TP938282', 'Tan Hong Chinx', '1fef1cb31844b0300e33210506377461', 'Student', 'male', '123245643434', '01111982215', 'hongchifwn42@gmail.com', 'qwe', '993.01', 'starbucks_logo_desktop20Jan2015183643.jpg');
...
CREATE TABLE IF NOT EXISTS `food` (
  ...
  PRIMARY KEY (`Food_ID`)
) ENGINE=MyISAM AUTO_INCREMENT=50003 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=40141 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=60017 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=30003 DEFAULT CHARSET=latin1;
...
(30001, 'Cardi B', 'e342ef77adc328d7e9654b2543fdac4e', 'System Admin', '892083029911', '019-9330293', 'ali_maju@gmail.com', 'female'),
(30002, 'enimem', 'e342ef77adc328d7e9654b2543fdac4e', 'Finance Department', '839028728177', '019-9290938', 'eninem@gmail.com', 'male');
...
(10001, 'david western ', 'e342ef77adc328d7e9654b2543fdac4e', 'David Bakem', 'Pita ', 'western', 'maily selling western food.Want other food? go other side!', '0293000000', 'pita_pan@gmail.com'),
(10002, 'sarah', 'e342ef77adc328d7e9654b2543fdac4e', 'sarah siti ', 'sarah\'s malay stall', 'malay', 'mainly selling malay food ', '029-9992029', 'sarah_malay@gmai.com'),
(10003, 'ah meng ', '523cbae9edf8fea49fba3d45afd63abd', 'meng chia hua', 'Ah Meng\'s Mix rice ', 'chinese ', 'mainly selling chinese mix rice', '029-87665272', 'ahmeng@gmail.com'),
(10004, 'Jacob indian', 'e342ef77adc328d7e9654b2543fdac4e', 'Jacob Arjun', 'Arjun Indian Crusine', 'indian', 'maily produce indian food ', '0199993029', 'jacod@gmail.com\r\n'),
(10005, 'Asad', 'e342ef77adc328d7e9654b2543fdac4e', 'Asab ', 'Asab Arab crusine ', 'arab', 'produce deliciosu arab crusine ', '0194889487', 'asab@gmail.com'),
(10006, 'Victoria ', 'e342ef77adc328d7e9654b2543fdac4e', 'Victoria secret', 'Victoria Bakery', 'bakery', 'produce fresh bread daily', '0298765267', 'victoria@gmail.com'),
(10007, 'john dessert', 'e342ef77adc328d7e9654b2543fdac4e', 'john snow', 'john snow dessert house', 'dessert', 'maily making delicious dessert', '0980997652', 'john_snow@gmail.com'),
(10008, 'Arnold beverage', 'e342ef77adc328d7e9654b2543fdac4e', 'Arnold giam', 'Arnold beverage ', 'beverage', 'delicious beverage', '0197766544', 'arnold@gmail.com');
COMMIT;
