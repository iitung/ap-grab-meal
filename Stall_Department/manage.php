			...
			<?php
				...
				while($food = mysqli_fetch_array($result)){
					if(($food['Stall_ID']) === ($_SESSION['login_stallid'])){
						...
						echo "<a href='delete.php?id=".$food['Food_ID']."' name='delete' class='btnm btn btn-outline-danger'>Delete</a>";
						echo "<a href='edit.php?id=".$food['Food_ID']."' name='edit' class='btnm btn btn-outline-info'>Edit</a>";
						echo "</td>";
						echo "</tr>";
						echo "</tbody>";
					}
