...
echo "<img class='menu_food_images' src='../Stall_Department/images/".$row['Food_File']."' >";
...
echo "<input type='text' name='food_quantity' style='width:50px;' class='food_input_amount float-right' value='1' >";
