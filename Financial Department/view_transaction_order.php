 ...
 <div class="trans-nav">
  <div class="dropbtn dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <a class="dropdown-item" href="view_transaction_order">Food Order</a>
      <a class="dropdown-item" href="view_transaction_customer">Customer Invoice</a>
      <a class="dropdown-item" href="view_transaction_credit">Credit Invoice</a>
    </div>
  </div>
