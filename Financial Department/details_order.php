...
<?php
  if (isset($_GET['id'])){
    ...
    while($row2 = mysqli_fetch_array($sql2)){
     ...
     echo "<img src='../System Admin/images/".$cust_pic."' class='img-circle' width='260' height='200' style='border-radius:50%';> ";
     echo "</div>";
  ...
  <div class="order-detail-frame">
    <?php $split_food_id = str_split($food_id, 4);
     ...
     foreach (array_unique($food_array) as $food_n) {
       ...
       echo "<img src='../Stall_Department/images/".$food_pic."' width='230' height='220' border='2'>";
       echo "</div>";
