...
echo "<img class='home-news img-thumbnail' src='../System Admin/images/".$row['Post_File']."' >";
}
...
echo "<div class='outside_container '>";
  while($row = mysqli_fetch_array($sql)){
    ...
    echo "<img src='../Stall_Department/images/".$row['Food_File']."' alt='Avatar' class='post_image img-thumbnail' style='width:100%''>";
