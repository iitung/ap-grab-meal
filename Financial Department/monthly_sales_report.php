...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    if (!isset($_POST['monthly-submit'])){
      ...
      echo "<script>window.location.href='monthly_sales.php';</script>";
    }
     ?>
...
<hr style="height:1px; margin: 200px 0 0 0;">
    ...
    <button type="button" class="btn btn-outline-primary"><a href="monthly_sales.php">Cancel</a></button>
    </div>
